      ...
      <div className="flex min-h-[80vh]">
        ...
        <div className="flex w-full items-center justify-center px-6 py-12 lg:w-1/2">
          <div className="w-full max-w-md">
            <div className="rounded-3xl border border-lavender-100/60 bg-white p-8 shadow-card text-center">
              {/* Mobile logo */}
              ...
              {/* Mail icon */}
              <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-full bg-lavender-50">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-royal-400" viewBox="0 0 20 20" fill="currentColor">
              ...
              <p className="mt-3 leading-relaxed text-royal-500">
                أرسلنا رابط تأكيد إلى{" "}
                <span dir="ltr" className="font-bold text-royal-600">
                  {email}
                </span>
              ...
              {signedUpType === "organization" && (
                <div className="mt-4 flex items-start gap-2 rounded-2xl bg-coral-50 p-3 text-sm font-bold text-coral-700">
      ...
      <div className="flex w-full items-center justify-center px-6 py-12 lg:w-1/2">
        <div className="w-full max-w-md">
          <div className="rounded-3xl border border-lavender-100/60 bg-white p-8 shadow-card">
            ...
            <h1 className="text-2xl font-extrabold text-navy-900">حساب جديد</h1>
            <p className="mt-2 text-royal-500">دقيقة واحدة وتكونين جاهزة للبدء ✨</p>

            {/* Account type toggle */}
            <fieldset className="mt-6">
              <legend className="mb-2 block font-bold text-navy-700">نوع الحساب</legend>
                  ...
                  <button
                    ...
                    className={`rounded-2xl border-2 p-4 text-right transition-all duration-200 ${
                      accountType === opt.value
                        ? "border-royal-500 bg-royal-50 shadow-soft"
                        : "border-lavender-100 bg-white hover:border-royal-200 hover:shadow-sm"
                    }`}
                  >
                    <span className="block text-3xl">{opt.icon}</span>
                    <span className="mt-2 block font-extrabold text-navy-900">
                      {opt.label}
                    </span>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              {/* Name */}
              <div>
                <label htmlFor="name" className="mb-1 block font-bold text-navy-700">
                  {accountType === "organization"
              ...
              {accountType === "organization" && (
                <>
                  <div>
                    <label htmlFor="orgName" className="mb-1 block font-bold text-navy-700">
                  ...
                  <div>
                    <label htmlFor="orgDescription" className="mb-1 block font-bold text-navy-700">
                  ...
                  <div>
                    <label htmlFor="orgWebsite" className="mb-1 block font-bold text-navy-700">
                  ...
                  <div>
                    <label htmlFor="orgContactEmail" className="mb-1 block font-bold text-navy-700">
              ...
              {/* Confirm password */}
              <div>
                <label htmlFor="confirm" className="mb-1 block font-bold text-navy-700">
                  تأكيد كلمة المرور
                </label>
                <div className="relative">
                  <span className="pointer-events-none absolute start-3 top-1/2 -translate-y-1/2 text-navy-400">
