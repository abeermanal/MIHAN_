  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      <body className="flex min-h-screen flex-col font-sans">
        ...
        <footer className="border-t border-cream-200 bg-navy-900 text-cream-100">
          <div className="mx-auto max-w-6xl px-4 py-12">
            <div className="grid gap-10 md:grid-cols-3">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col leading-none">
                    <span className="text-lg font-extrabold text-white">مِهَن</span>
                    <span className="text-[10px] font-bold tracking-wider text-lavender-400">MIHAN</span>
                  </div>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-cream-300">
                  <li>
                    <a href="/" className="transition hover:text-lavender-400">الرئيسية</a>
                  </li>
                  <li>
              ...
              {/* Social */}
              <div>
                <h4 className="mb-4 text-sm font-bold text-white">تابعينا</h4>
                <div className="flex gap-3">
                  {/* Twitter / X */}
                  <a
                    href="#"
                    aria-label="تويتر"
                    className="grid h-10 w-10 place-items-center rounded-xl bg-navy-800 text-cream-300 transition hover:bg-royal-600 hover:text-white"
                  >
            ...
            <div className="mt-10 border-t border-navy-800 pt-6 text-center text-xs text-cream-400">
