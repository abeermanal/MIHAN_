export default function SetupNotice({ error }: { error?: string }) {
  return (
    <div className="card border-gold-200 bg-gold-50">
      <h2 className="text-lg font-extrabold text-gold-800">⚠️ إعداد مطلوب</h2>
      <p className="mt-2 leading-relaxed text-gold-900">
        {error ??
      ...
      <ol className="mt-3 list-decimal space-y-1 pr-5 text-sm text-gold-900">
